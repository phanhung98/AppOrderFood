...
import com.example.admin.apporderfood.Model.Rating;
import com.example.admin.apporderfood.R;
import com.example.admin.apporderfood.ViewHolder.ShowCommentViewHolder;
...
public class ShowComment extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView=(RecyclerView)findViewById(R.id.recycleShowComment) ;
        layoutManager=new LinearLayoutManager(this);
        recyclerView.setLayoutManager(layoutManager);

       swipeRefreshLayout=(SwipeRefreshLayout)findViewById(R.id.swipe_comment_layout);
       swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
           ...
           public void onRefresh() {
               if (getIntent() != null){
                   ...
                   {
                       Query query= ratingtbl.child(Common.currentUser.getPhone()).orderByChild("foodId").equalTo(foodId);
